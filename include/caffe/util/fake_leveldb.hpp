...
public:
	...
	virtual Iterator* NewIterator( size_t max_open_files, int canonical_size, int color_type ) = 0;
...
public:
	...
	Iterator* NewIterator( size_t max_open_files = 2, int canonical_size = 0, int color_type = BGR_COLOR );
...
public:
	...
	Iterator* NewIterator( size_t max_open_files = 20, int canonical_size = 0, int color_type = BGR_COLOR  );
