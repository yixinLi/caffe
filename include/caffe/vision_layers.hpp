...
class TanhLayer : public NeuronLayer<Dtype> {
 public:
  ...
  shared_ptr<SyncedMemory> buffer_;
...
// Local layer, written by Yuting Zhang
template <typename Dtype>
class LocalLayer : public Layer<Dtype> {
 ...
 protected:
  ...
  int GROUP_;
  Blob<Dtype> col_buffer_;
  shared_ptr<SyncedMemory> mul_buffer_;
  shared_ptr<SyncedMemory> sum_multiplier_;
  bool biasterm_;
  int M_;
  int K_;
  int N_;
...
class DataLayer : public Layer<Dtype> {
 ...
 protected:
  ...
  shared_ptr<caffe_modified::fake_leveldb> db_;
  shared_ptr<caffe_modified::fake_leveldb::Iterator> iter_;
  int datum_channels_;
  int datum_height_;
  int datum_width_;
  int datum_size_;
...
// Pair-wise Siamese Loss, batch number has to be even
template <typename Dtype>
class SiameseLossLayer : public Layer<Dtype> {
 ...
 protected:
  ...
  Dtype alpha_;
  Dtype exp_neg_beta_;
  Dtype regular_weight_;

  shared_ptr<SyncedMemory> block_data_;
  shared_ptr<SyncedMemory> error_data_;
  shared_ptr<SyncedMemory> loss_data_;
